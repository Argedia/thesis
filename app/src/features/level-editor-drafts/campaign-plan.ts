...
export const CAMPAIGN_PLAN_TEMPLATES: CampaignPlanTemplate[] = [
  ...
  {
    id: "w1-l3",
    name: "W1-L3 · Leer estado inicial/objetivo",
    worldId: "w1",
    worldName: "Onboarding Editor",
    difficulty: 1.5,
    maxSteps: 6,
  ...
  {
    id: "w2-l2",
    name: "W2-L2 · Build stack from scratch",
    worldId: "w2",
    worldName: "Estructuras por defecto",
    difficulty: 1.5,
    maxSteps: 12,
  ...
  {
    id: "w2-l3",
    name: "W2-L3 · Queue front transfer",
    worldId: "w2",
    worldName: "Estructuras por defecto",
    difficulty: 1.5,
    maxSteps: 8,
  ...
  {
    id: "w2-l5",
    name: "W2-L5 · List append/prepend",
    worldId: "w2",
    worldName: "Estructuras por defecto",
    difficulty: 1.5,
    maxSteps: 10,
  ...
  {
    id: "w2-l8",
    name: "W2-L8 · Checkpoint default DS",
    worldId: "w2",
    worldName: "Estructuras por defecto",
    difficulty: 3.0,
    maxSteps: 16,
